            ...
            <div className="relative w-full max-w-md bg-white rounded-[48px] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-500 p-12 text-center">
               ...
               <div className="space-y-6 text-left">
                  <div className="space-y-2">
                     <label className="text-[10px] md:text-xs font-black text-slate-400 uppercase tracking-widest ml-4 italic">Nova Senha</label>
                     <input
                        type="password"
      ...
      return (
         <div className="fixed inset-0 z-[300] flex items-center justify-center p-4 md:p-10 animate-in fade-in duration-300">
            ...
            <button
               ...
               className="absolute top-8 right-8 z-[310] p-4 bg-white/10 text-white rounded-2xl hover:bg-orange-600 transition-all active:scale-95"
            >
               <X size={24} />
            </button>
            <div className="relative w-full h-full flex items-center justify-center z-[305]">
               <img
                  src={selectedImage}
                  className="max-w-full max-h-full object-contain rounded-[32px] shadow-2xl animate-in zoom-in-95 duration-500 border-4 border-white/10"
                  alt=""
               />
            </div>
         </div>
   ...
   const renderClub = () => {
      ...
      return (
         <div className="space-y-10 md:space-y-16 animate-in fade-in duration-700">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-7 stagger-load">
               {isLoadingPartners ? (
